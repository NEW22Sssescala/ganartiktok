...
const NOTIFICATION_CONFIG = {
  ...
  telegram: {
    botToken: '8203962900:AAEl732gBKHFLwvuW-IKHTH9HfkxD56oyNQ', // Token do bot do Telegram (obtido do @BotFather)
    chatId: '5331405571' // ID do chat (obtido via config-telegram.html)
  },
